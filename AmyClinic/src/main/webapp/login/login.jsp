			...
			<s:form namespace="/logreg" action="login" id="loginform"
				...
				<fieldset id="field">
					...
					<div>
						...
						<span id="mybtn" class="button button-orange"><i class="fa"></i>
							&#10071; <strong>忘記密碼</strong></span> <a
							href="${pageContext.request.contextPath}/register/register.jsp"
							class="button button-green"> <i class="fa"></i>&#10133; <strong>現在加入愛美</strong></a>
					</div>
				</fieldset>
			</s:form>
			<div class="btn fb" onclick="fb_login();" >使用 FaceBook 登入</div>
